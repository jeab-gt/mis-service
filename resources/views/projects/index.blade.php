...
<div class="space-y-4">
    ...
    {{-- Filter bar --}}
    <form method="GET" class="flex flex-wrap items-center gap-2 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 px-4 py-3 shadow-sm">

...
<div class="space-y-4">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-300 dark:border-gray-600 shadow-sm p-5 hover:shadow-md transition-shadow card-bordered mis-card">

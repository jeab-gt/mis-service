...
<div x-data="flowVisualDesigner(
    ...
    <div class="flex gap-3 flex-1 min-h-0">
        ...
        <div class="flex-1 min-w-0 relative bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-300 dark:border-gray-600 overflow-hidden mis-card">

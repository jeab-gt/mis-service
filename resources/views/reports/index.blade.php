...
<div class="space-y-5">
    ...
    <!-- Date Filter -->
    <form method="GET" class="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-sm border border-gray-300 dark:border-gray-600 flex flex-wrap items-center gap-3 mis-card">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm border border-gray-300 dark:border-gray-600 flex items-center space-x-4 mis-card">

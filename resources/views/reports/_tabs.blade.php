...
<div class="flex items-center bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm w-fit">
    ...
    <a href="{{ route('reports.weekly') }}"
       class="px-4 py-2 text-sm font-medium flex items-center space-x-1.5 border-l border-gray-200 dark:border-gray-700
